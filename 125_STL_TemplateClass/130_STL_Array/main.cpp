...
void test4() {
    ...
    std::sort(arr1.begin(), arr1.end()); //sort è un algoritm
    display(arr1);
}
...
void test7() {
    ...
    int sum = std::accumulate(arr1.begin(), arr1.end(), 0); //Somma tutti valori degli array. lo zero iniziale è da dove parte. Attenzione: se cambio tipo (es double) devo partire da 0.0
