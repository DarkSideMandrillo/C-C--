// Section 20
// Set - Ordina automaticamente. Non funziona [] e .at()
...
public:
    ...
    bool operator<(const Person &rhs) const {
        return this->age < rhs.age;  // Il set Usa Age per ordinare, perchè usa questo op
    }
    bool operator==(const Person &rhs) const {
...
void test3() {
    ...
    std::cout << "first: " <<  *(result.first)<< std::endl; //Iterator 
    std::cout  << "second: " << result.second << std::endl; //bool
