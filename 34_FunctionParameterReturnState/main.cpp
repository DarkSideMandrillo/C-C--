...
/*---Passati tutti byValue, perciò nella funzione creano una COPIA----*/
...
int main() {
    ...
    cout << "\nanother_num before calling pass_by_value1: " << anotherNum << endl;
    pass_by_value1(anotherNum);
    cout << "another_num after calling pass_by_value1: " << anotherNum << endl;
