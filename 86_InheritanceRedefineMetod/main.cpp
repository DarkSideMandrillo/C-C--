...
// #include <iostream> // Chiamato da Account
#include "Savings_Account.h" // Chiamo Savings_Account che a sua volta chiama Account
...
int main()
{
    ...
    s1.deposit(1000); // Mi chiama il metodo di Savings_Account
    cout << s1 << endl; // Savings Account balance: 2050, Interest rate: 5

    s1.withdraw(2000); // Mi chiama il metodo di Account pubblico
