...
/*
Ogni singolo ptr creato(che è un oggetto) ha all'interno il numero di
ptr che puntano all'hipe. Ogni volta che un ptr viene resettato (o esce da scope)
Tutti i ptr rimasti decrementano il numero
*/
