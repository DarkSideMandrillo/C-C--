...
void static_local_example()
{
    // La seconda volta che si chiama la funzione non si inizializza più. Static
...
int main()
{
    ...
    cout << "\nCall local _example 2 time - with 10 and 20" << endl;
    local_example(10);
    local_example(20);

    cout << "\nCall global _example 2 time" << endl;
    global_example();
    global_example();

    cout << "\nCall Static_local_example 3 time" << endl;
