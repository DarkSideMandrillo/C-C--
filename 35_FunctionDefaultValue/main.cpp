...
double calc_cost(double baseCost = 100.0, double tax_rate = 0.06, double shipping = 3.50);

void greeting(string name,  string prefix = "Mr.", string suffix = "");

double calc_cost(double baseCost, double taxRate, double shipping) {
...
int main() {
    ...
    cost = calc_cost(0.010);                         // will use default tax and shipping   200 + 12 + 3.50
